...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if( empty($_POST['ins']) ) {
        $erreur['ins'] = 'Le champs INS est obligatoire';
        $formulaire_valide = false;
    }
    ...
    <form method="post" action="../index.php?page=inscription_patient">
        ...
        <div class="row margininscription">
            ...
            <div class="col-lg-4">
                ...
                <input type="text" class="form-control" id="ins" placeholder="Saisissez l'INS" name="ins">
        ...
        <?php if($envoye) echo '<div class="alert alert-success">Patient enregistré !</div>'; ?>
